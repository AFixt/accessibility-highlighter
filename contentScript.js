...
function runAccessibilityChecks() {
	...
	for (let i = 0; i < tableElementsWithoutTH.length; i++) {
		...
		overlay.call(tableElementsWithoutTH[i], "overlay", "error", "table without any th elements");
	}
	...
	const imageElementsWithTitleAndEmptyAlt = document.querySelectorAll("img[alt=''][title]:not([alt])");
